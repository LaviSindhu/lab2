public record DateInterval(SimpleDate start, SimpleDate end) {
    ...
    // This makes sure the end date is not before the start date
    public DateInterval {
    ...
    // this returns true if the two intervals overlap
    ...
    // this returns the intersection of two date intervals or null if they do not overlap
    ...
    // this returns the intersection of two maybe-date-intervals, or null if either input is null or they do not overlap
